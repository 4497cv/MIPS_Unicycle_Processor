...
add wave -noupdate -radix binary /MIPS_Processor_TB/DUV/BRANCHNE_AND_ZERO/C
add wave -noupdate -radix binary /MIPS_Processor_TB/DUV/ArithmeticLogicUnitControl/ALUOp
add wave -noupdate -radix binary /MIPS_Processor_TB/DUV/ArithmeticLogicUnitControl/ALUFunction
add wave -noupdate -radix hexadecimal /MIPS_Processor_TB/DUV/ArithmeticLogicUnitControl/ALUOperation
add wave -noupdate -radix hexadecimal /MIPS_Processor_TB/DUV/ArithmeticLogicUnitControl/ALUControlValues
add wave -noupdate /MIPS_Processor_TB/DUV/ArithmeticLogicUnitControl/Selector
add wave -noupdate /MIPS_Processor_TB/DUV/JALMODULE/PC_4
add wave -noupdate /MIPS_Processor_TB/DUV/JALMODULE/address
add wave -noupdate /MIPS_Processor_TB/DUV/JALMODULE/JumpAddr
...
add wave -noupdate /MIPS_Processor_TB/DUV/ControlUnit/JumpAndLink
add wave -noupdate /MIPS_Processor_TB/DUV/ControlUnit/ZeroImm
add wave -noupdate /MIPS_Processor_TB/DUV/ControlUnit/LUI
